...
<div class="pageContent">
	<form id="sysMenuEditForm" onsubmit="return divSearch(this, 'menuBox');" 
		action="${pageContext.request.contextPath}/system/menu/add/0?tid=${param.tid}" method="post"></form>
...
function menuTreeClick(event, treeId, treeNode, clickFlag){
	...
	var url='${pageContext.request.contextPath}/system/menu/edit/' + id + '?tid=${param.tid}';
