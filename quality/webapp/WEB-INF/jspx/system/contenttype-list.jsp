...
<div class="pageHeader">
  <form id="pagerForm" onsubmit="return navTabSearch(this);" action="${pageContext.request.contextPath}/system/contenttype/list" method="post">
	...
	<thead><tr>
	  ...
	  <td><div class="buttonActive"><a target="dialog" mask="true" maxable="false" resizable="false" width="500" height="260" rel="dlg-code-edit" href="${pageContext.request.contextPath}/system/contenttype/edit/0?tid=${param.tid}" title="添加"><span>添加</span></a></div></td>
	</tr></thead>
	</table>
	</div>
  </form>
	...
	<tbody>
		<c:forEach var="c" items="${page.result}" varStatus="st">
			<tr>
				...
				<td>${c.name}</td>
				<td>&nbsp;
					<a target="dialog" mask="true" maxable="false" resizable="false" width="500" height="260" rel="dlg-code-edit" href="${pageContext.request.contextPath}/system/contenttype/edit/${c.id}?tid=${param.tid}" title="编辑" class="font-blue">编辑</a>&nbsp;&nbsp;
					<a target="ajaxTodo" title="删除后将不可恢复，请确认?" href="${pageContext.request.contextPath}/system/contenttype/del/${c.id}?tid=${param.tid}" class="font-red">删除</a>&nbsp;&nbsp;
				</td>
			</tr>
		</c:forEach>
