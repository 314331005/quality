...
<div class="pageContent">
	<form id="sysDeptEditForm" onsubmit="return divSearch(this, 'deptBox');" 
		action="${pageContext.request.contextPath}/system/dept/add/0?tid=${param.tid}" method="post"></form>
...
function deptTreeClick(event, treeId, treeNode, clickFlag){
	...
	var url='${pageContext.request.contextPath}/system/dept/edit/' + id + '?tid=${param.tid}';
