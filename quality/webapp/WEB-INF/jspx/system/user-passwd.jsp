...
<form id="dlgPasswdForm" action="${pageContext.request.contextPath}/system/user/passwd/update" method="post"
	onsubmit="return validateCallback(this, dialogAjaxDone);" class="pageForm required-validate">
	<div class="panelBar">
		<ul class="toolBar">
			<li style="float:right"><a class="add"><span id="dlgPasswdFormBtn" submitForm="dlgPasswdForm">保存</span></a></li>
