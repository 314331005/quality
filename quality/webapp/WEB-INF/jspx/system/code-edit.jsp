...
<form id="saveSysCodeForm" action="${pageContext.request.contextPath}/system/code/save" method="post" 
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li style="float:right;"><a class="add"><span submitForm="saveSysCodeForm">保存系统编码信息</span></a></li>
		</ul>
	</div>
				...
				<td width="80%">
					<c:choose>
						<c:when test="${not empty c.id}">
							...
							<a class="font-blue">${jashon_map:get(dics['syscode'], c.type)}</a>
						</c:when>
						<c:otherwise>
