...
<div id="login">
	<div id="login_header">
		<h1 class="login_logo">
			<a><img src="image/login/logo.png" /></a>
		</h1>
		<div class="login_headerContent">
			...
			<h2 class="login_title"><img src="image/login/logo_r.png" /></h2>
		</div>
	</div>
	<div id="login_content">
		...
		<div class="login_banner"><img src="image/login/banner.jpg" /></div>
	</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/javascript/verifycode.js"></script>
